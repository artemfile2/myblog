    ...
    <div>
        <div class="wrap">
            <div class="col-1 border-2">
                <h2 class="p3">Новости сайта</h2>
                <div class="wrap">
                    <img src="assets/images/page1-img4.png" alt="" class="img-indent img-radius">
                    <p class="extra-wrap">Group is one of <a href="" class="link" target="_blank">free website templates</a> created by TemplateMonster.com. This website template is optimized for 1280X1024 screen resolution. This <a href="" class="link" target="_blank" rel="nofollow">Security Group Template</a> goes with 2 packages – with PSD source files and without them. PSD source files are available for free for the registered members of TemplateMonster.com.</p>
                </div>
